...
export const metadata: Metadata = {
  ...
  description: 'Calcomanías y stickers de alta calidad para maquinaria pesada. CAT, Volvo, Komatsu, JCB, John Deere, Case, Terex y más. +7,000 modelos disponibles con +6 años de duración a la intemperie. Envío a toda la República Mexicana.',
  keywords: [
    'calcomanías para maquinaria pesada',
    'calcas para maquinaria',
    'stickers para excavadora',
    'calcomanías CAT',
    'calcomanías Caterpillar',
    'calcomanías Komatsu',
    'calcomanías Volvo',
    'calcomanías John Deere',
    'calcomanías JCB',
    'calcomanías Case',
    'calcomanías Terex',
    'calcas excavadora',
  ...
  openGraph: {
    ...
    description: 'Calcomanías de alta calidad para maquinaria pesada. CAT, Komatsu, Volvo, JCB, Deere y más marcas. Envío a toda la República.',
    images: [
      {
  ...
  return (
    <html lang="es">
      <head>
        <Script id="gtm-script" strategy="afterInteractive">
          {`
            ...
            })(window,document,'script','dataLayer','GTM-WQFQMJJD');
          `}
        </Script>
      </head>
      <body className={`${_inter.variable} font-sans antialiased`}>
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-WQFQMJJD"
            height="0"
            width="0"
