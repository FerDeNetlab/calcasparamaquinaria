...
export default function InventarioPage() {
    ...
    const handleDelete = async () => {
        ...
        try {
            const res = await fetch('/api/admin/products', { method: 'DELETE', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ id: selectedProduct.id }) })
                ...
                {loading ? (
                    ...
                    <div className="bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden">
                        ...
                        <div className="border-t border-zinc-800 px-5 py-3 flex items-center justify-between">
                            <p className="text-zinc-600 text-sm">Página {page} de {totalPages} · {total.toLocaleString()} productos</p>
